            ...
            <div className='signin-right-content gradient-custom-2'>
              <div className='signin-right-text'>
                ...
                <p className='right-description'>
                  BioForge empowers creators, professionals, and brands to craft
                  beautiful, personalized bio pages that showcase their digital
                  identity. Join thousands of users who trust us to manage their
                  online presence with style and simplicity.
                </p>
