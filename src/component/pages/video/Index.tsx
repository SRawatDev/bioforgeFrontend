...
const Index: React.FC<Props> = ({ getUserDetail }) => {
  ...
  const Detail = async () => {
    setLoader(true)
    try {
      const response = await callAPI(apiUrls.getAllVideo, {}, 'GET', {})
      setLoader(false)
      ...
      <div className='links-page-content'>
        ...
        <div className='links-header'>
          <div className='header-top'>
            ...
            >
              <IoVideocamOutline className='button-icon' />
              Add New Video
            </button>
          </div>
                        ...
                        <div className='link-item-content'>
                          <div className='link-item-details'>
                            <div className='link-title-container'>
                              <h3 className='link-title d-flex gap-2'>
                                {item.videoTitle}
              ...
              !loader && (
                <div className='no-links'>
                  <div className='no-links-content'>
                    ...
                    <h3>No Video Added Yet</h3>
                    <p>
                      Add your first Video to get started with your BioForge
