//apply searching in add products in links
...
export const LinksAddEdit: React.FC<Props> = ({
  open,
  onClose,
  Detail,
  linkDetail,
  ...
  const handleChange = (
    ...
    if (name === 'LinkCategoryId') {
      ...
      const selected = socialPlatforms.find(
        p =>
          p.label.toLowerCase() === value.toLowerCase() ||
 ...
 setLink(prev => ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (link.type === 'social' && link.linkTitle === '') {
      ErrorMessage('Please select link title')
      return
                      ...
                      {socialPlatforms.map(platform => (
                        <label
                          ...
                          className={`platform-option ${
                            link.linkTitle === platform.label ? 'selected' : ''
                          }`}
                          style={
                            {
              ...
              <div className='form-section'>
                <div className='input-group'>
                  <InputField
                    ...
                    placeholder={
                      link.type === 'social'
                        ? `Enter your ${link.linkTitle || 'social'} profile URL`
                        : 'https://example.com'
                    }
                  />
                </div>
                      ...
                      <div className='selected-products'>
                        ...
                        <ul>
                          {link.LinkCategoryId.map(id => {
                            ...
                            return (
                              <li key={id}>
                                {foundProduct?.title || 'Unknown Product'}
                                <button
                                  type='button'
                                  onClick={() =>
                                    setLink(prev => ({
