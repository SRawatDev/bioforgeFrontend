      ...
      {loader ? (
        ...
        <div
          ...
          style={{
            ...
            background: userInfo?.banner_img 
              ? `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.6)), url(${defaultConfig?.imagePath + userInfo?.banner_img})`
              : 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat',
            fontFamily: userInfo?.theme?.fontFamily || '"Inter", system-ui, sans-serif',
            display: 'flex',
            alignItems: 'center',
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundColor: userInfo?.theme?.is_colorImage || 'rgba(255, 255, 255, 0.95)',
              ...
              position: 'relative',
              backgroundImage: userInfo?.banner_img ? `url(${defaultConfig?.imagePath + userInfo?.banner_img})` : 'none',
              backgroundSize: 'cover',
              backgroundPosition: 'center',
              backgroundRepeat: 'no-repeat',
            }}
            ...
            >
              ...
              <h1
                style={{
                  ...
                  letterSpacing: '-0.8px',
                  fontFamily: userInfo?.theme?.fontFamily || 'inherit',
                }}
              >
                @{userInfo?.username}
              </h1>
              ...
              <p
                style={{
                  fontSize: '16px',
                  lineHeight: '1.6',
                  color: userInfo?.theme?.fontColor || '#6b7280',
                  margin: '0 0 24px',
                  fontWeight: '400',
                  maxWidth: '300px',
                  marginLeft: 'auto',
              ...
              <div
                style={{
                  ...
                  alignItems: 'center',
                  gap: '10px',
                  backgroundColor: userInfo?.theme?.is_colorImage || '#f8fafc',
                  border: '1px solid #e2e8f0',
                  borderRadius: '16px',
                  padding: '14px 20px',
                  fontSize: '14px',
                  color: userInfo?.theme?.fontColor || '#475569',
                  fontWeight: '600',
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                    {userInfo.non_social.map((link, index) => (
                      ...
                      >
                        ...
                        {/* Link Text */}
                        <span style={{ flex: 1, fontSize: '16px' }}>{link.linkTitle}</span>
